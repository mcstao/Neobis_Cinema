    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_work', models.TimeField(default=django.utils.timezone.now, verbose_name='Начало работы')),
                ('end_work', models.TimeField(default=django.utils.timezone.now, verbose_name='Конец работы')),
            ],
        ),
        migrations.CreateModel(
            name='Discount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_day', models.DateField(default=django.utils.timezone.now, verbose_name='День релиза')),
                ('end_day', models.DateField(default=django.utils.timezone.now, verbose_name='День окончания проката')),
            ],
        ),
        migrations.CreateModel(
            name='MovieSession',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('show_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Время показа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pay_method', models.CharField(choices=[('card', 'Картой'), ('cash', 'Наличные')], max_length=20, verbose_name='Метод оплаты')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('cinema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cinema_app.cinema')),
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cinema_app.discount')),
